...
export type Step = StepBase &
	(
		...
		| { type: 'back' }
		| { type: 'tapOn'; selector: SelectorSpec }
		| { type: 'doubleTapOn'; selector: SelectorSpec }
		| { type: 'inputText'; text: string; selector?: SelectorSpec }
		| { type: 'eraseText'; characters?: number; selector?: SelectorSpec }
		| { type: 'pressKey'; key: string }
		| { type: 'assertVisible'; selector: SelectorSpec }
		| { type: 'assertNotVisible'; selector: SelectorSpec }
		| { type: 'assertTitle'; pattern: string }
		| { type: 'assertUrl'; pattern: string }
		| { type: 'scroll'; direction?: 'up' | 'down'; amount?: number }
		| { type: 'scrollUntilVisible'; selector: SelectorSpec }
		| { type: 'wait'; ms: number }
		...
		| { type: 'evalScript'; script: string }
		| { type: 'copyTextFrom'; selector: SelectorSpec }
		| { type: 'pasteText' }
		| { type: 'runFlow'; file: string; env?: Record<string, string> }
