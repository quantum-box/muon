...
const REQUEST_HISTORY_KEY = 'muon_request_history'
...
export function addRequestHistory(entry: RequestHistoryEntry): void {
...
export function deleteRequestHistoryEntry(id: string): void {
	const items = getRequestHistory().filter(r => r.id !== id)
